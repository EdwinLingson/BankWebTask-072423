...
<div class="card-header py-3 h4">Please Enter your Details: </div>
    <form class="row g-3 p-3" action="managerRegResult.jsp" method="post">
      ...
      <div class="row mb-3">
        <label for="address" class="col-sm-2 col-form-label">Date of Joining</label>
        <div class="col-sm-7">
          <input type="date" class="form-control" id="address" placeholder="Enter your ZIP code" name="doj" required>
        </div>
      </div>
